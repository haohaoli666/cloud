...
QT_MOC_LITERAL(5, 29, 21) // "on_Register_2_clicked"

    },
    "Register\0info\0\0name\0password\0"
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->info((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Register::info)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Register::info(QString _t1, QString _t2)
{
